#ifndef __CPFLOAT_PROP_BASE_SIN_HH__
#define __CPFLOAT_PROP_BASE_SIN_HH__

#include <cpfloat/cpfloat.hh>

namespace MPG { namespace CPFloat { namespace Prop {
/**
 * \brief Propagates: \f$ y = sin(x) \f$
 * \ingroup SetProp
 */
template <typename ViewLeft, typename ViewRight>
class Sin : public Gecode::Propagator {
protected:
  ...
  ViewRight right_;
public:
  /// Constructor for the propagator \f$ sin(left,right) \f$
  Sin(Gecode::Home home, ViewLeft left, ViewRight right)
  ...
  static Gecode::ExecStatus post(Gecode::Home home,
    ...
    /// the constraint?
    (void) new (home) Sin(home,left,right);
    return Gecode::ES_OK;
  }
  /// Propagator disposal
  ...
  /// Copy constructor
  Sin(Gecode::Space& home, bool share, Sin& p)
  ...
  virtual Gecode::Propagator* copy(Gecode::Space& home, bool share) {
    return new (home) Sin(home,share,*this);
  }
  /// Cost
