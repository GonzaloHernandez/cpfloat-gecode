#ifndef __CPFLOAT_PROP_BASE_ASIN_HH__
#define __CPFLOAT_PROP_BASE_ASIN_HH__

#include <cpfloat/cpfloat.hh>

namespace MPG { namespace CPFloat { namespace Prop {
/**
 * \brief Propagates: \f$ y = asin(x) \f$
 * \ingroup SetProp
 */
template <typename ViewLeft, typename ViewRight>
class Asin : public Gecode::Propagator {
protected:
  ...
  ViewRight right_;
public:
  /// Constructor for the propagator \f$ asin(left,right) \f$
  Asin(Gecode::Home home, ViewLeft left, ViewRight right)
  ...
  static Gecode::ExecStatus post(Gecode::Home home,
    ...
    /// the constraint?
    (void) new (home) Asin(home,left,right);
    return Gecode::ES_OK;
  }
  /// Propagator disposal
  ...
  /// Copy constructor
  Asin(Gecode::Space& home, bool share, Asin& p)
  ...
  virtual Gecode::Propagator* copy(Gecode::Space& home, bool share) {
    return new (home) Asin(home,share,*this);
  }
  /// Cost
