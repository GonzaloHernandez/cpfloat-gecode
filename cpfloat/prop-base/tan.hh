#ifndef __CPFLOAT_PROP_BASE_TAN_HH__
#define __CPFLOAT_PROP_BASE_TAN_HH__

#include <cpfloat/cpfloat.hh>

namespace MPG { namespace CPFloat { namespace Prop {
/**
 * \brief Propagates: \f$ y = tan(x) \f$
 * \ingroup SetProp
 */
template <typename ViewLeft, typename ViewRight>
class Tan : public Gecode::Propagator {
protected:
  ...
  ViewRight right_;
public:
  /// Constructor for the propagator \f$ tan(left,right) \f$
  Tan(Gecode::Home home, ViewLeft left, ViewRight right)
  ...
  static Gecode::ExecStatus post(Gecode::Home home,
    ...
    /// the constraint?
    (void) new (home) Tan(home,left,right);
    return Gecode::ES_OK;
  }
  /// Propagator disposal
  ...
  /// Copy constructor
  Tan(Gecode::Space& home, bool share, Tan& p)
  ...
  virtual Gecode::Propagator* copy(Gecode::Space& home, bool share) {
    return new (home) Tan(home,share,*this);
  }
  /// Cost
