#ifndef __CPFLOAT_PROP_BASE_COS_HH__
#define __CPFLOAT_PROP_BASE_COS_HH__

#include <cpfloat/cpfloat.hh>

namespace MPG { namespace CPFloat { namespace Prop {
/**
 * \brief Propagates: \f$ y = cos(x) \f$
 * \ingroup SetProp
 */
template <typename ViewLeft, typename ViewRight>
class Cos : public Gecode::Propagator {
protected:
  ...
  ViewRight right_;
public:
  /// Constructor for the propagator \f$ cos(left,right) \f$
  Cos(Gecode::Home home, ViewLeft left, ViewRight right)
  ...
  static Gecode::ExecStatus post(Gecode::Home home,
    ...
    /// the constraint?
    (void) new (home) Cos(home,left,right);
    return Gecode::ES_OK;
  }
  /// Propagator disposal
  ...
  /// Copy constructor
  Cos(Gecode::Space& home, bool share, Cos& p)
  ...
  virtual Gecode::Propagator* copy(Gecode::Space& home, bool share) {
    return new (home) Cos(home,share,*this);
  }
  /// Cost
  ...
  virtual Gecode::ExecStatus propagate(Gecode::Space& home,
    ...
    //std::cout << "Propagating cos(x)" << std::endl;
