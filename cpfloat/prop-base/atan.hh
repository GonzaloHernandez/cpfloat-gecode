#ifndef __CPFLOAT_PROP_BASE_ATAN_HH__
#define __CPFLOAT_PROP_BASE_ATAN_HH__

#include <cpfloat/cpfloat.hh>

namespace MPG { namespace CPFloat { namespace Prop {
/**
 * \brief Propagates: \f$ y = atan(x) \f$
 * \ingroup SetProp
 */
template <typename ViewLeft, typename ViewRight>
class Atan : public Gecode::Propagator {
protected:
  ...
  ViewRight right_;
public:
  /// Constructor for the propagator \f$ atan(left,right) \f$
  Atan(Gecode::Home home, ViewLeft left, ViewRight right)
  ...
  static Gecode::ExecStatus post(Gecode::Home home,
    ...
    /// the constraint?
    (void) new (home) Atan(home,left,right);
    return Gecode::ES_OK;
  }
  /// Propagator disposal
  ...
  /// Copy constructor
  Atan(Gecode::Space& home, bool share, Atan& p)
  ...
  virtual Gecode::Propagator* copy(Gecode::Space& home, bool share) {
    return new (home) Atan(home,share,*this);
  }
  /// Cost
