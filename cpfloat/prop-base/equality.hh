...
/**
 * \brief Propagates: \f$ y = x \f$
 * \ingroup SetProp
 */
template <typename ViewLeft, typename ViewRight>
class Equality : public Gecode::Propagator {
protected:
  ...
  ViewRight right_;
public:
  /// Constructor for the propagator \f$ equality(left,right) \f$
  Equality(Gecode::Home home, ViewLeft left, ViewRight right)
  ...
  static Gecode::ExecStatus post(Gecode::Home home,
    ...
    /// the constraint?
    (void) new (home) Equality(home,left,right);
    return Gecode::ES_OK;
  }
  /// Propagator disposal
  ...
  /// Copy constructor
  Equality(Gecode::Space& home, bool share, Equality& p)
