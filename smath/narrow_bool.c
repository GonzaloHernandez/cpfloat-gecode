...
/*
extern double pos_inf,neg_inf,max_real,min_real,zero,neg_zero;
...
int narrow_lessfn(INTERVAL *x, INTERVAL *y, INTERVAL *r)
{
/*** narrow x, y ****/    
     if (r->lo==1.0)                                   /* r = 1 */
...
int narrow_leqfn(INTERVAL *x, INTERVAL *y, INTERVAL *r)
{
/*** narrow x, y ****/    
     if (r->lo==1.0)                                   /* r = 1 */
...
int narrow_eqfn(INTERVAL *x, INTERVAL *y, INTERVAL *r)
{
/*** narrow x, y ****/    
     if (r->lo==1.0)                                   /* r = 1 */
